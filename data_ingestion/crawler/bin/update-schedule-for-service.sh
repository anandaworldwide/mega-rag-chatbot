...
aws scheduler update-schedule \
    ...
    --description "Run crawler hourly 24/7 (38m max) (uses Fargate Spot)" \
    --target "{
...
echo "  Schedule: hourly, 24/7 (America/Los_Angeles)"
echo "  Capacity: 95% Fargate Spot, 5% Fargate on-demand (fallback)"
echo "  Runtime: 38 minutes max (max-runtime-minutes=38)"
echo ""
